...
mex -g -O -largeArrayDims mxLshCreate.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
mex -g -O -largeArrayDims mxLshInsert.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
mex -g -O -largeArrayDims mxLshSearch.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
mex -g -O -largeArrayDims mxLshBucketId.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
mex -g -O -largeArrayDims mxLshFuncVal.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
mex -g -O -largeArrayDims mxLshBucketPoints.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\

mex -g -O -largeArrayDims mxLshKnn.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0

mex -g -O -largeArrayDims mxLshClean.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\

mex -g -O -largeArrayDims mxLshSave.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
mex -g -O -largeArrayDims mxLshLoad.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
mex -g -O -largeArrayDims mxLshStats.cpp ccLsh.cpp ccDistance.cpp -IC:\boost_1_55_0\
