function [inv, words_part] = inv_build_pyramid(words, coords, img_size, params)
    if(~exist('params','var'))
    ...
    fprintf('Done analysis word parts! Creating inverted file index...\n');
    inv = inv_create_spm_c(words_part);
end