function ivf = ccvInvFileInsert(ivf, data, nwords, idshift)
% CCVINVFILEFILL inserts data to an inverted file structure
%
% INPUTS
% ------
...
%call the mex file
ivf = mxInvFileFillData(ivf, data, nwords, idshift);
