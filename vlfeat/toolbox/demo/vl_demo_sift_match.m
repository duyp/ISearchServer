...
[fa,da] = vl_covdet(im2single(rgb2gray(Ia)), 'method', 'Hessian', 'estimateAffineShape', true);
[fb,db] = vl_covdet(im2single(rgb2gray(Ib)), 'method', 'Hessian', 'estimateAffineShape', true);
